...
#define GRAYSCALE_BASE_ADDR XPAR_GRAYSCALE_0_S00_AXI_BASEADDR
...
int main()
{
    ...
    AXI_VDMA<ScuGicInterruptController> vdma_driver(VDMA_DEVID, MEM_BASE_ADDR,
                                                    irpt_ctl, VDMA_MM2S_IRPT_ID,
                                                    VDMA_S2MM_IRPT_ID);
    VideoOutput vid(XPAR_VTC_0_DEVICE_ID, XPAR_CLK_WIZ_1_DEVICE_ID);

    pipeline_mode_change(vdma_driver, cam, vid, Resolution::R1920_1080_60_PP,
    ...
    while (1)
    {
        ...
        case 'a':
            xil_printf(
                "\r\n  Please press the key corresponding to the desired "
                "resolution:");
            xil_printf("\r\n    1. 1280 x 720, 60fps");
            xil_printf("\r\n    2. 1920 x 1080, 15fps");
            xil_printf("\r\n    3. 1920 x 1080, 30fps");
            ...
            case '1':
                pipeline_mode_change(
                    vdma_driver, cam, vid, Resolution::R1280_720_60_PP,
                    OV5640_cfg::mode_t::MODE_720P_1280_720_60fps);
                xil_printf("Resolution change done.\r\n");
                break;
            case '2':
                pipeline_mode_change(
                    vdma_driver, cam, vid, Resolution::R1920_1080_60_PP,
        ...
        case 'b':
            xil_printf(
                "\r\n\r\nPlease enter value of liquid lens register, in "
                "hex, with small letters: 0x");
            ...
            getchar();
            // If character is a digit, convert from ASCII code to a digit
            // between 0 and 9
            if (read_char1 <= 57)
            {
                read_char1 -= 48;
            }
            // If character is a letter, convert ASCII code to a number
            // between 10 and 15
            else
            {
                read_char1 -= 87;
        ...
        case 'd':
            xil_printf(
                ...
                "setting:");
            xil_printf(
                "\r\n    1. Select image format to be RGB, output still "
                "Raw");
            xil_printf(
        ...
        case 'e':
            xil_printf(
                "\r\nPlease enter address of image sensor register, in "
                "hex, with small letters: \r\n");
            // A, B, C,..., F need to be entered with small letters
            while (read_char1 < 48)
            {
                read_char1 = getchar();
            ...
            reg_addr =
                16 * (16 * (16 * read_char1 + read_char2) + read_char4) +
                read_char5;
            ...
            read_char2 = 0;
            xil_printf(
                "\r\nPlease enter value of image sensor register, in hex, "
                "with small letters: \r\n");
            // A, B, C,..., F need to be entered with small letters
            while (read_char1 < 48)
            {
        ...
        case 'f':
            xil_printf(
                "Please enter address of image sensor register, in hex, "
                "with small letters: \r\n");
            // A, B, C,..., F need to be entered with small letters
            while (read_char1 < 48)
            {
        ...
        case 'g':
            xil_printf(
                "  Please press the key corresponding to the desired Gamma "
                "factor:\r\n");
        ...
        case 'h':
            xil_printf(
                "  Please press the key corresponding to the desired AWB "
                "change:\r\n");
